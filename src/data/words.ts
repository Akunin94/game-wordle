...
export const VALID_GUESSES: readonly string[] = [
  ...
  'qaroq', 'qayli', 'qiyin', 'qizim', 'qolip', 'qorin', 'qovuq',
  'raqam', 'raqib', 'rasmi', 'ravis', 'rayon',
  'rejim', 'robot', 'roziy', 'rubob', 'rukun', 'rutba', 'sadaf', 'sahih',
  'sakin', 'salat', 'sanaq', 'sarpo', 'satin', 'savdo', 'senga', 'serka',
  'shahd', 'shart', 'shayx', 'sinov', 'sipoh', 'siyoh', 'sodda',
  ...
  'hamda', 'harir', 'hayol', 'hozir', 'ichak', 'iloji', 'inson',
  'jaran', 'jamal', 'jarla', 'jazza', 'kabin', 'kamon', 'kanda',
  'kitoa', 'komuz', 'kumos', 'kuydi', 'lolqo', 'manzi', 'marom',
  'mazax', 'milni', 'minor', 'mitri', 'mohit', 'mosiy', 'motam',
  'munis', 'muzaf', 'namsi', 'narni', 'nashr', 'navli', 'nekos',
