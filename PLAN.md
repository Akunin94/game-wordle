...
Этот файл — контекст для продолжения работы над проектом новой сессией Claude.
Всё написано так, чтобы можно было начать с нуля, не перечитывая предыдущий диалог.
